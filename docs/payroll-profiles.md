...
Usage: freeagent payroll-profiles [OPTIONS] <COMMAND>

Commands:
  list-year  List payroll profiles for a year
...
### payroll-profiles list-year

```
List payroll profiles for a year

Usage: freeagent payroll-profiles list-year [OPTIONS] <YEAR>
